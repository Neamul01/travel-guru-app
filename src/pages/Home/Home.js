        ...
        <div className='h-screen' style={{ backgroundImage: `linear-gradient(to left, rgba(0, 0, 0, 0.663), rgba(0, 0, 0, 0.619)), url(${coxs})` }}>
            <div className='flex items-center h-screen text-white'>
                <div className=' ml-16'>
                    ...
                    <button className='text-black bg-yellow-500 rounded-lg py-3 px-6'>Booking</button>
                </div>

                <div className='w-96 h-96 m-2 px-3 hover:border-yellow-500 border-4 hover:border-4 rounded-2xl relative'
                    style={{ backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.409), rgba(219, 219, 219, 0)), url(${coxs})`, backgroundSize: 'cover' }}>

                    <h2 className='uppercase text-4xl absolute bottom-6'>cox's bazar</h2>
                </div>

                <div className='w-96 h-96 m-2 px-3 hover:border-yellow-500 border-4 hover:border-4 rounded-2xl relative'
                    style={{ backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.409), rgba(219, 219, 219, 0)), url(${sentMartin})`, backgroundSize: 'cover' }}>
                ...
                <div className='w-96 h-96 ml-2 px-3 hover:border-yellow-500 border-4 hover:border-4 rounded-2xl relative'
                    style={{ backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.409), rgba(219, 219, 219, 0)), url(${sundarban})`, backgroundSize: 'cover' }}>
